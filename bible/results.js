input.oninput = function() {
  setTimeout(function() {
    ...
    var checkBox = document.getElementById("showacts");
    if (checkBox.checked == true){
    	    /* Acts */
	      textset = acts.split(" ");
        matchescount = 0;
	    ...
	    if (matchescount !== 0) {
	        actscount.innerHTML = matchescount;
	        actsmatch.innerHTML = outputmatch;

	    } else {
	      actscount.innerHTML = 0;
		    actsmatch.innerHTML = "N/A";
	    }
	  }
    var checkBox = document.getElementById("showromans");
    if (checkBox.checked == true){
    	    /* Romans */
	      textset = romans.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        romanscount.innerHTML = matchescount;
	        romansmatch.innerHTML = outputmatch;

	    } else {
	      romanscount.innerHTML = 0;
		    romansmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showcorinth1");
    if (checkBox.checked == true){
    	    /* Corintheans 1 */
	      textset = corinth1.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        corinth1count.innerHTML = matchescount;
	        corinth1match.innerHTML = outputmatch;

	    } else {
	      corinth1count.innerHTML = 0;
		    corinth1match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showcorinth2");
    if (checkBox.checked == true){
    	    /* Corintheans 2 */
	      textset = corinth2.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        corinth2count.innerHTML = matchescount;
	        corinth2match.innerHTML = outputmatch;

	    } else {
	      corinth2count.innerHTML = 0;
		    corinth2match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showgalatians");
    if (checkBox.checked == true){
    	    /* Galatians */
	      textset = galatians.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        galatianscount.innerHTML = matchescount;
	        galatiansmatch.innerHTML = outputmatch;

	    } else {
	      galatianscount.innerHTML = 0;
		    galatiansmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showephesians");
    if (checkBox.checked == true){
    	    /* Ephesians */
	      textset = ephesians.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        ephesianscount.innerHTML = matchescount;
	        ephesiansmatch.innerHTML = outputmatch;

	    } else {
	      ephesianscount.innerHTML = 0;
		    ephesiansmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showphilipians");
    if (checkBox.checked == true){
    	    /* Philipians */
	      textset = philipians.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        philipianscount.innerHTML = matchescount;
	        philipiansmatch.innerHTML = outputmatch;

	    } else {
	      philipianscount.innerHTML = 0;
		    philipiansmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showcolossins");
    if (checkBox.checked == true){
    	    /* Colossins */
	      textset = colossins.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        colossinscount.innerHTML = matchescount;
	        colossinsmatch.innerHTML = outputmatch;

	    } else {
	      colossinscount.innerHTML = 0;
		    colossinsmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showthessalonians1");
    if (checkBox.checked == true){
    	    /* 1 Thessalonians */
	      textset = thessalonians1.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        thessalonians1count.innerHTML = matchescount;
	        thessalonians1match.innerHTML = outputmatch;

	    } else {
	      thessalonians1count.innerHTML = 0;
		    thessalonians1match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showthessalonians2");
    if (checkBox.checked == true){
    	    /* 2 Thessalonians */
	      textset = thessalonians2.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        thessalonians2count.innerHTML = matchescount;
	        thessalonians2match.innerHTML = outputmatch;

	    } else {
	      thessalonians2count.innerHTML = 0;
		    thessalonians2match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showtimothy1");
    if (checkBox.checked == true){
    	    /* 1 Timothy */
	      textset = timothy1.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        timothy1count.innerHTML = matchescount;
	        timothy1match.innerHTML = outputmatch;

	    } else {
	      timothy1count.innerHTML = 0;
		    timothy1match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showtimothy2");
    if (checkBox.checked == true){
    	    /* 2 Timothy */
	      textset = timothy2.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        timothy2count.innerHTML = matchescount;
	        timothy2match.innerHTML = outputmatch;

	    } else {
	      timothy2count.innerHTML = 0;
		    timothy2match.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showtitus");
    if (checkBox.checked == true){
    	    /* Titus */
	      textset = titus.split(" ");
        matchescount = 0;
	    ...
	    if (matchescount !== 0) {
	        tituscount.innerHTML = matchescount;
	        titusmatch.innerHTML = outputmatch;

	    } else {
	      tituscount.innerHTML = 0;
		    titusmatch.innerHTML = "N/A";
	    }
    }
    var checkBox = document.getElementById("showphilemon");
    if (checkBox.checked == true){
    	    /* Philemon */
	      textset = philemon.split(" ");
        matchescount = 0;
        outputmatch = "";
        teststr = "";
        testword = "";
	    ...
	    if (matchescount !== 0) {
	        philemoncount.innerHTML = matchescount;
	        philemonmatch.innerHTML = outputmatch;

	    } else {
	      philemoncount.innerHTML = 0;
